...
class SO101Task(base.Task):
    ...
    def _precompute_bin_aabb(self, physics, bin_name="left_bin_center"):
        # call in reset(); store on self
        site_id = physics.model.site(bin_name).id
    ...
    def get_observation(self, physics):
        ...
        id_cube_site = physics.model.site("red_block_site").id
        ...
        obs["box_position"] = cube_pos.astype(np.float32)  # SO101 uses float32
        obs["bin_position"] = self.bin_center.astype(np.float32)  # SO101 uses float32
